		...
		<>
			<div className="barra-lateral">
				...
				<ul>
					...
					<li style={select == "cadastrar categoria" ? styleSelect : {}} onClick={() => {handleSelect("cadastrar categoria")}}><img src={categories} alt="cadastrar categoria" /> Cadastrar Categoria </li>
